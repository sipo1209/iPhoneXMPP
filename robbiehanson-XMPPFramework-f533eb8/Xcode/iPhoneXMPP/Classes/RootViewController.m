...
//    [messagetosend addAttributeWithName:@"to" stringValue:@"ankur@ankurs-macbook-pro.local"];
//    [messagetosend addChild:body];
//   
//    [[[self appDelegate]xmppStream] sendElement:messagetosend];
}

-(IBAction)createnode:(id)sender{
    XMPPPubSub *pubsub = [[self appDelegate] xmppPubSub];
    [pubsub createNode:@"hello" withOptions:nil];
